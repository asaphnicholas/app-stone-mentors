  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-gradient-to-r from-stone-green-dark via-stone-green-light to-stone-green-bright rounded-2xl p-8 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-between">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h1 className="text-4xl font-bold mb-2">Histórico de Mentorias</h1>
              <p className="text-white/90 text-xl">Acompanhamento completo do negócio "{historyData.negocio_nome}"</p>
              <p className="text-white/80 text-base">Visualize todo o progresso e evolução das mentorias</p>
            </div>
          </div>
      ...
      <Card className="border-0 bg-gradient-to-br ">
        <CardHeader>
          <CardTitle className="flex items-center gap-4 text-2xl">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900">{historyData.negocio_nome}</h2>
              <Badge className="bg-blue-500 text-white font-semibold px-4 py-1 mt-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="flex items-center gap-4 p-4 bg-white/60 rounded-xl shadow-sm">
              ...
              <div>
                ...
                <p className="font-bold text-gray-900">{historyData.empreendedor_nome}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-white/60 rounded-xl shadow-sm">
              ...
              <div>
                ...
                <p className="font-bold text-gray-900">{historyData.telefone}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-white/60 rounded-xl shadow-sm">
              ...
              <div>
                ...
                <p className="font-bold text-gray-900">{historyData.localizacao}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-white/60 rounded-xl shadow-sm">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600">Vinculado em</p>
                <p className="font-bold text-gray-900">{formatDateToBR(historyData.data_vinculacao)}</p>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="border-0 shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 bg-gradient-to-br from-blue-50 to-indigo-50">
          <CardContent className="p-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{historyData.total_mentorias}</p>
        ...
        <Card className="border-0 shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 bg-gradient-to-br from-green-50 to-emerald-50">
          <CardContent className="p-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{historyData.mentorias_finalizadas}</p>
        ...
        <Card className="border-0 shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 bg-gradient-to-br from-yellow-50 to-orange-50">
          <CardContent className="p-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{historyData.nps_medio.toFixed(1)}</p>
            ...
            <Card key={mentoria.id} className="border-0 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 bg-gradient-to-br from-white to-gray-50 overflow-hidden">
              <div className="relative">
                ...
                {index < historyData.mentorias.length - 1 && (
                  <div className="absolute left-8 top-20 w-0.5 h-16 bg-gradient-to-b from-stone-green-light to-stone-green-dark z-10"></div>
                )}
                ...
                <CardContent className="p-8">
                  ...
                  <div className="flex items-start justify-between mb-6">
                    <div className="flex items-center gap-4">
                      <div className="relative">
                        <div className="w-16 h-16 bg-gradient-to-br from-stone-green-light to-stone-green-dark rounded-2xl flex items-center justify-center shadow-lg z-20">
                      ...
                      <div>
                        <h3 className="text-xl font-bold text-gray-900 mb-1">{getTipoText(mentoria.tipo)}</h3>
                        <div className="flex items-center gap-4 text-gray-600">
                          <div className="flex items-center gap-2">
                            <FontAwesomeIcon icon={faCalendarAlt} className="h-4 w-4" />
                            <span className="font-medium">{formatDateTimeToBR(mentoria.data_agendada)}</span>
                          </div>
                          <div className="flex items-center gap-2">
                    ...
                    <Badge className={`${getStatusColor(mentoria.status)} font-semibold px-4 py-2 text-sm`}>
                    ...
                    <div className="mb-6 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-200 shadow-sm">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                        {mentoria.diagnostico.tempo_mercado && (
                          <div className="p-3 bg-white/60 rounded-xl">
                            ...
                            <p className="font-bold text-gray-900">{mentoria.diagnostico.tempo_mercado}</p>
                          </div>
                        )}
                        {mentoria.diagnostico.faturamento_mensal && (
                          <div className="p-3 bg-white/60 rounded-xl">
                            ...
                            <p className="font-bold text-gray-900">{mentoria.diagnostico.faturamento_mensal}</p>
                          </div>
                        )}
                        {mentoria.diagnostico.num_funcionarios && (
                          <div className="p-3 bg-white/60 rounded-xl">
                            ...
                            <p className="font-bold text-gray-900">{mentoria.diagnostico.num_funcionarios}</p>
                          </div>
                        )}
                      </div>
                      {mentoria.diagnostico.desafios && mentoria.diagnostico.desafios.length > 0 && (
                        <div className="mb-4 p-3 bg-white/60 rounded-xl">
                          ...
                          <p className="font-bold text-gray-900">{mentoria.diagnostico.desafios.join(', ')}</p>
                        </div>
                      )}
                      {mentoria.diagnostico.observacoes && (
                        <div className="p-3 bg-white/60 rounded-xl">
                          ...
                          <p className="text-gray-900 leading-relaxed">{mentoria.diagnostico.observacoes}</p>
                        </div>
                      )}
                    </div>
                  )}
                  ...
                  {/* Checkout */}
                  {mentoria.checkout && (
                    <div className="mb-6 p-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl border border-green-200 shadow-sm">
                      <h4 className="font-bold text-green-900 mb-4 flex items-center gap-3 text-lg">
                        <div className="w-8 h-8 bg-gradient-to-br from-green-500 to-emerald-500 rounded-lg flex items-center justify-center">
                          <FontAwesomeIcon icon={faAward} className="h-4 w-4 text-white" />
                        </div>
                        Avaliação Final
                      </h4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div className="p-4 bg-white/60 rounded-xl text-center">
                          <div className="flex items-center justify-center gap-2 mb-2">
                            ...
                            <span className="text-sm font-medium text-gray-600 uppercase tracking-wide">NPS Score</span>
                          </div>
                          <div className="flex items-center justify-center gap-3">
                            <span className={`text-4xl font-bold ${getNPSColor(mentoria.checkout.nps)}`}>
                              {mentoria.checkout.nps}
                            </span>
                            <Badge className={`${getNPSColor(mentoria.checkout.nps).replace('text-', 'bg-').replace('-600', '-100')} ${getNPSColor(mentoria.checkout.nps)} border-0`}>
                      ...
                      {mentoria.checkout.feedback && (
                        <div className="p-4 bg-white/60 rounded-xl">
                          <div className="flex items-center gap-2 mb-2">
                            <FontAwesomeIcon icon={faComments} className="h-4 w-4 text-green-600" />
                            <span className="text-xs font-medium text-gray-600 uppercase tracking-wide">Feedback</span>
                          </div>
                          <p className="text-gray-900 leading-relaxed">{mentoria.checkout.feedback}</p>
                        </div>
                      )}
                    </div>
                  )}
                  ...
                  {/* Timestamps */}
                  <div className="flex flex-wrap gap-4 text-sm text-gray-500 pt-4 border-t border-gray-200">
                    <div className="flex items-center gap-2">
      ...
      {/* Ações */}
      <Card className="border-0 shadow-xl bg-gradient-to-r from-stone-green-light/10 to-stone-green-dark/10">
        <CardContent className="p-8">
          <div className="flex flex-col md:flex-row justify-center gap-6">
            <Button
              onClick={() => handleContact(historyData.telefone)}
              className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white shadow-lg h-14 px-8 text-lg font-semibold"
            >
              <FontAwesomeIcon icon={faWhatsapp} className="h-5 w-5 mr-3" />
              Contatar via WhatsApp
            </Button>
            <Button
              onClick={() => router.push("/mentor/mentorias")}
              variant="outline"
              className="border-2 border-stone-green-dark text-stone-green-dark hover:bg-stone-green-dark hover:text-white h-14 px-8 text-lg font-semibold"
            >
              <FontAwesomeIcon icon={faArrowLeft} className="h-5 w-5 mr-3" />
              Voltar às Mentorias
            </Button>
